...
<body class="easyui-layout">
	...
	<div class="wu-sidebar"
		...
		<div title="项目申报管理" data-options="iconCls:'icon-book'"
				style="padding: 10px">
				<a href="javascript:openTab(' 项目计划书','apply.jsp','icon-bricks')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-bricks'">项目计划书</a>
					<a href="javascript:openTab(' 申报历史','applyList_user.jsp','icon-bricks')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-bricks'">申报历史</a>
					</div>
			<div title="项目信息管理" data-options="iconCls:'icon-book'"
				style="padding: 10px">
				<a
				...
				<a
					href="javascript:openTab(' 项目关系人','allBooksManage.jsp','icon-bricks')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-bricks'">项目关系人</a>
			</div>
